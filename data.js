...
// =========================================
// Edit this object to change things site-wide (phone number, maps URL, hours,
// service area). Values are pushed into the DOM at runtime by applySiteConfig()
// in script.js — every tel: link, every maps link, and the contact page's
// hours / area spans all stay in sync with what you put here.
//
// NOT auto-synced (static HTML for SEO crawlers — must be edited by hand):
//   • index.html  — the <script type="application/ld+json"> block (telephone,
//                   openingHoursSpecification.opens/closes, hasMap)
// If you change `whatsappNumber`, `mapsUrl`, or `hours.opens/closes` here,
// also update those fields in that JSON-LD block.
const SITE_CONFIG = {
  // International format, no + or spaces. Used by every WhatsApp + tel: link.
  whatsappNumber: '966507028521',

  // Human-readable phone display (shown as the visible text inside tel: links
  // that currently render the phone number — buttons like "Call Us" are left
  // alone because their label isn't a phone number).
  phoneDisplay: '+966 50 702 8521',

  // Google Maps short-link. Used by every footer "Find Us" link.
  mapsUrl: 'https://maps.app.goo.gl/YijaAuDi3qwFzWi97?g_st=iwb',

  // Business hours — shown on the contact page in both languages.
  // opens/closes are the 24h-format values used by JSON-LD (edit index.html too if changed).
  hours: {
    en: 'Daily — Flexible appointments',
    ar: 'يومياً — مواعيد مرنة',
    opens: '10:00',
    closes: '22:00'
  },

  // Service area — shown on the contact page in both languages.
  serviceArea: {
    en: 'Riyadh, Saudi Arabia — Home Service',
    ar: 'الرياض، المملكة العربية السعودية — خدمة منزلية'
  }
};
...
const SERVICES_DATA = {
  massage: {
    ...
    items: [
      ...
      {en:'Deep Tissue Massage', ar:'تدليك الانسجة العميق', desc_en:'A deep pressure massage targeting tight muscles and knots, ideal for chronic muscle pain.', desc_ar:'مساج عميق يركز على العضلات المشدودة والعقد، مناسب لآلام الظهر والرقبة والعضلات المزمنة.', price:500, duration:60},
      ...
      {en:'Hot Stone Massage', ar:'تدليك الأحجار الساخنة', desc_en:'A massage using warm stones to deeply relax muscles, relieve tension, and improve circulation.', desc_ar:'مساج بحجارة ساخنة يساعد على استرخاء العضلات بعمق وتخفيف التوتر وتحسين الدورة الدموية.', price:450, duration:60},
      ...
      {en:'Thai Herbal Thermal Massage', ar:'تدليك حراري بالعشاب التايلندية', desc_en:'A massage using warm Thai herbal compresses to ease muscle pain and promote deep relaxation.', desc_ar:'مساج بأكياس أعشاب تايلندية دافئة، يخفف آلام العضلات ويحسّن الاسترخاء.', price:500, duration:60},
      {en:'Lymphatic & Slimming Massage', ar:'تدليك لمفاوي و تدليك للتنحيف', desc_en:'A massage to stimulate lymphatic drainage, reduce swelling, and improve body contour.', desc_ar:'مساج لتصريف السوائل وتنشيط الجهاز الليمفاوي، يساعد على تقليل الانتفاخ وتحسين مظهر الجسم.', price:500, duration:60},
    ...
    addons: [
      ...
      {en:'Scented Oil', ar:'زيت عطري', price:50}
    ]
  },
  ...
  nails: {
    ...
    sections: {
      basic: { title_en: 'Mani & Pedi', title_ar: 'مانيكير وباديكير', items: [
        ...
        {en:'Mani & Pedi for Kids with Color', ar:'مانيكير و باديكير مع لون للأطفال', price:150}
      ]},
      biab: { title_en: 'Biab', title_ar: 'بياب', items: [
        {en:'Biab Manicure Overlay', ar:'مانيكير بياب كامل الاظافر', price:350},
        ...
        {en:'Biab Ombre', ar:'بياب اومبرية', price:550}
      ]},
      gel: { title_en: 'Gel', title_ar: 'الجل', items: [
        ...
        {en:'Half Gel Tip Extensions', ar:'تركيب نصف اظفر لكامل اليدين', price:450},
        {en:'Soft Gel Tip Extensions', ar:'تركيب اظافر كامل اليدين', price:500},
        {en:'Gel Extensions Removal', ar:'إزالة جل اكستنشن', price:150},
        {en:'Gel Color Only', ar:'لون جل فقط', price:300},
        {en:'Gel Color Refill', ar:'إعادة لون الجل', price:100},
        {en:'Gel Removal', ar:'إزالة لون جل', price:60},
        {en:'Gel French', ar:'فرنش جل', price:250},
        {en:'Gel Ombre', ar:'اومبرية جل', price:300}
      ]},
      addons: { title_en: 'Add-Ons', title_ar: 'إضافات', items: [
        {en:'Cat Eye', ar:'كات أي', price:240},
        {en:'Chrome', ar:'كروم', price:180},
        {en:'Basic Hand Color', ar:'لون ايدي عادي', price:35},
        {en:'Basic Feet Color', ar:'لون اقدام عادي', price:35},
        {en:'French Hand Color', ar:'لون ايدي فرنش عادي', price:60},
        {en:'French Feet Color', ar:'لون اقدام فرنش عادي', price:60},
        {en:'Nail Art Single Finger', ar:'رسم للظفر الواحد', price:20},
        {en:'Nail Art Full Set', ar:'رسم كامل الاظافر', price:200},
        {en:'Artificial Nails', ar:'تركيب اظافر عادي', price:100}
      ]}
    }
  },
  ...
  waxing: {
    ...
    items: [
      ...
      {en:'Wax Full Legs', ar:'شمع كامل الارجل', price:120},
      {en:'Wax Half Legs', ar:'شمع نصف الارجل', price:60},
      {en:'Wax Full Hands', ar:'شمع كامل الايدي', price:100},
      {en:'Wax Half Hands', ar:'شمع نصف الايدي', price:50},
      {en:'Wax Under Arms', ar:'شمع تحت الابط', price:50},
